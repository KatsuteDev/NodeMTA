...
goog.exportSymbol('transit_realtime.Alert', null, proto);
goog.exportSymbol('transit_realtime.Alert.Cause', null, proto);
goog.exportSymbol('transit_realtime.Alert.Effect', null, proto);
goog.exportSymbol('transit_realtime.Alert.SeverityLevel', null, proto);
goog.exportSymbol('transit_realtime.EntitySelector', null, proto);
goog.exportSymbol('transit_realtime.FeedEntity', null, proto);
goog.exportSymbol('transit_realtime.FeedHeader', null, proto);
goog.exportSymbol('transit_realtime.FeedHeader.Incrementality', null, proto);
goog.exportSymbol('transit_realtime.FeedMessage', null, proto);
goog.exportSymbol('transit_realtime.Position', null, proto);
goog.exportSymbol('transit_realtime.TimeRange', null, proto);
goog.exportSymbol('transit_realtime.TranslatedString', null, proto);
goog.exportSymbol('transit_realtime.TranslatedString.Translation', null, proto);
goog.exportSymbol('transit_realtime.TripDescriptor', null, proto);
goog.exportSymbol('transit_realtime.TripDescriptor.ScheduleRelationship', null, proto);
goog.exportSymbol('transit_realtime.TripUpdate', null, proto);
goog.exportSymbol('transit_realtime.TripUpdate.StopTimeEvent', null, proto);
goog.exportSymbol('transit_realtime.TripUpdate.StopTimeUpdate', null, proto);
goog.exportSymbol('transit_realtime.TripUpdate.StopTimeUpdate.ScheduleRelationship', null, proto);
goog.exportSymbol('transit_realtime.TripUpdate.TripProperties', null, proto);
goog.exportSymbol('transit_realtime.VehicleDescriptor', null, proto);
goog.exportSymbol('transit_realtime.VehiclePosition', null, proto);
goog.exportSymbol('transit_realtime.VehiclePosition.CarriageDetails', null, proto);
goog.exportSymbol('transit_realtime.VehiclePosition.CongestionLevel', null, proto);
goog.exportSymbol('transit_realtime.VehiclePosition.OccupancyStatus', null, proto);
goog.exportSymbol('transit_realtime.VehiclePosition.VehicleStopStatus', null, proto);
/**
